<x-layout>
    ...
    <x-forms.form method='POST' action='/register' x-data="{ isAuthor: false }">
        ...
        <x-forms.input label='Password Confirmation' name='password_confirmation' type='password' placeholder='Re-enter your password' />
